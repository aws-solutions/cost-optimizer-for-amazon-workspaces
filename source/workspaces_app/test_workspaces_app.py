...
@unittest.mock.patch.dict(os.environ, {'LogLevel': '1',
    'DryRun': '1',
    'TestEndOfMonth': '1',
    'SendAnonymousData': '1',
    'SolutionVersion': '1',
...
@unittest.mock.patch('time.gmtime', unittest.mock.MagicMock(return_value=struct_time((2023, 1, 1, 1, 1, 1, 6, 1, 0))))
def test_get_stack_parameters():
    assert main.get_stack_parameters() == stack_parameters


@unittest.mock.patch('time.gmtime', unittest.mock.MagicMock(return_value=struct_time((2023, 1, 31, 1, 1, 1, 2, 31, 0))))
