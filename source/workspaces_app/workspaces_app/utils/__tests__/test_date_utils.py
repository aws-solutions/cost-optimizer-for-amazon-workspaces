...
@mock.patch('time.gmtime', mock.MagicMock(return_value=time.struct_time((2020, 11, 30, 0, 0, 0, 3, 335, -1))))
...
@mock.patch('time.gmtime', mock.MagicMock(return_value=time.struct_time((2020, 11, 29, 0, 0, 0, 3, 335, -1))))
