...
def test_process_workspace_standard(mocker, session):
    workspace = {
...
def test_process_workspace_performance(mocker, session):
    workspace = {
        'WorkspaceId': 'ws-68h123hty',
        'DirectoryId': 'd-901230bb84',
        'UserName': 'test_user',
...
def test_modify_workspace_properties_Always_On(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_modify_workspace_properties_Auto_stop(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_modify_workspace_properties_Exception(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_modify_workspace_properties_Auto_stop_Dry_Run_True(mocker, session):
...
def test_modify_workspace_properties_Always_On_Dry_Run_True(mocker, session):
...
def test_check_for_skip_tag_true(mocker, session):
...
def test_check_for_skip_tag_false(mocker, session):
...
def test_terminate_workspaces_yes(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_terminate_workspaces_no(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_workspace_available_yes(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_workspace_available_no(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_workspace_available_exception(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_workspaces(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_workspaces_exception(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_if_workspace_needs_to_be_terminated_1(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_if_workspace_needs_to_be_terminated_2(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_if_workspace_needs_to_be_terminated_3(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_if_workspace_needs_to_be_terminated_4(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_if_workspace_needs_to_be_terminated_5(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_terminate_unused_workspace_exception(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_terminate_unused_workspace_failed_request(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_terminate_unused_workspace_yes(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_workspace_usage_for_current_month_None(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_workspace_usage_for_current_month_false(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_check_workspace_usage_for_current_month_true(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_last_known_user_connection_timestamp(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_last_known_user_connection_timestamp_exception(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_termination_status_1(session):
    workspaces_helper.TERMINATE_UNUSED_WORKSPACES = 'No'
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_termination_status_2(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
    ...
    tags = []
    workspace_helper = workspaces_helper.WorkspacesHelper(session, settings)
    workspaces_helper.TERMINATE_UNUSED_WORKSPACES = 'Yes'
    workspaces_helper.today = "2021-09-30"
    workspaces_helper.last_day = "2021-09-30"
...
def test_get_termination_status_3(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_termination_status_4(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_termination_status_5(mocker, session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
...
def test_get_workspaces_for_directory_return_exception(session):
    settings = {
        'region': 'us-east-1',
        'hourlyLimits': 10,
        'testEndOfMonth': 'yes',
