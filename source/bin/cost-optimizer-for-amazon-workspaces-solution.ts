...
const costOptimizerHubStackProperties: CostOptimizerHubStackProps = {
  ...
  description:
    ...
    ") - " +
    SOLUTION_NAME +
    ": A solution for automatically optimizing the cost of Amazon Workspaces version " +
    SOLUTION_VERSION,
...
const costOptimizerSpokeStackProperties: CostOptimizerSpokeStackProps = {
